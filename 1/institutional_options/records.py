...
class MTILRecordBuilder:
    ...
    def from_paper_trade(
        ...
        record = {
            ...
            "cost_model_valid": bool(evidence_snapshot.get("cost_model_valid", False)),
            "canonical_promotion_allowed": bool(evidence_snapshot.get("canonical_promotion_allowed", False)),
